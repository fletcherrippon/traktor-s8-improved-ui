...
// Original Maschine 2 Display Colors
  ...
  property variant waveformColorsMap: [
    ...
    // Special
    { low1:  rgba (220,  38,  38, 180),  low2:  rgba (234, 88,   12, 255),
      mid1:  rgba (234, 179,   8, 100),  mid2:  rgba (34, 197,   94, 255),
      high1: rgba (6,   182, 212, 100),  high2: rgba (91,  33,  182, 255)}
  ]

  function getDefaultWaveformColors()
  {
    // Set the default waveform colors
